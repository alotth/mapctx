...
Use when local board exists and GitHub issues/project items should be created or linked from it.
...
Use when GitHub issues/project items already exist and local files should be materialized.
...
- Respect `bootstrap.requireConfirmFlag` when local-first writes may create remote issues.
